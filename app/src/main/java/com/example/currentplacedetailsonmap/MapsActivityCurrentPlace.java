    ...
    public void onClick(View v){
        ...
        switch(v.getId()){
            case R.id.searchButton:
                EditText inputLoc = (EditText) findViewById(R.id.inputLoc);
                String location = inputLoc.getText().toString();
            ...
            case R.id.restaurants_button:
                ...
                Toast.makeText(MapsActivityCurrentPlace.this, "Showing nearby Restaurants", Toast.LENGTH_LONG).show();
                break;
            case R.id.dept_button:
                ...
                getNearbyPlacesData.execute(dataTransfer);
                Toast.makeText(MapsActivityCurrentPlace.this, "Showing nearby Department Stores", Toast.LENGTH_LONG).show();
                break;
            case R.id.groceries_button:
                ...
                getNearbyPlacesData.execute(dataTransfer);
                Toast.makeText(MapsActivityCurrentPlace.this, "Showing nearby Grocery Stores", Toast.LENGTH_LONG).show();
                break;
        }
    }
